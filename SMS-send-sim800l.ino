...
void setup() {
  ...
  updateSerial();
  sendSMS("+346xxxxxxxx", "Prueba SMS desde SIM800L - OK!");
...
void sendSMS(String telefono, String mensaje){
  ...
  updateSerial();
  Serial1.println("AT+CMGS=\"" + telefono + "\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
  Serial1.println(mensaje); //text content
  updateSerial();
  Serial1.write(26);
}